...
class OANDAEMAStrategy: 

    def __init__(self, instrument: str, short_halflife: float, long_halflife: float, start_date: str, end_date: str, granularity: str, long_short = False) -> None:
        self._instrument = instrument

        assert short_halflife < long_halflife, "The short half life has to be shorter than the long halflife"
